...
import com.voxtrail.voxtrail.adapter.DriveStopAdapter;
...
public class DriveStopReportFragment extends FragmentController implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
    ...
    public DriveStopReportFragment(DevicePOJO devicePOJO) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frag_drive_stop, container, false);
    ...
    public void callAPI() {
        ...
        try {
            if (!et_stop_duration.getText().toString().trim().equalsIgnoreCase("")) {
                nameValuePairs.add(new BasicNameValuePair("stop_duration", String.valueOf(Integer.parseInt(et_stop_duration.getText().toString()))));
            } else {
        ...
        new WebServiceBaseResponse<DriveStopPOJO>(nameValuePairs, getActivity(), new ResponseCallBack<DriveStopPOJO>() {

            @Override
            public void onGetMsg(ResponsePOJO<DriveStopPOJO> responsePOJO) {
                activityManager.dismissProgressBar();
                swipeRefreshLayout.setRefreshing(false);
                driveStopResultPOJOS.clear();
                try {
                    if (responsePOJO.isSuccess()) {
                        driveStopResultPOJOS.addAll(responsePOJO.getResult().getDriveStopResultPOJOS());
                    } else {
        ...
        }, DriveStopPOJO.class, "DRIVE_IN_OUT_REPORT", false).execute(WebServicesUrls.DRIVE_STOP_API);
    }

    DriveStopAdapter zoneInOutAdapter;
    List<DriveStopResultPOJO> driveStopResultPOJOS = new ArrayList<>();

    public void attachAdapter() {
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false);
        rv_zone_report.setHasFixedSize(true);
        rv_zone_report.setLayoutManager(linearLayoutManager);
        zoneInOutAdapter = new DriveStopAdapter(getActivity(), null, driveStopResultPOJOS);
