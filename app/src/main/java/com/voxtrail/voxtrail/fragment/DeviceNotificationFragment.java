...
public class DeviceNotificationFragment extends FragmentController {
    ...
    public DeviceNotificationFragment(DevicePOJO devicePOJO) {
    ...
    public void callNotificationAPI() {
        ...
        }, LastEventPOJO.class, "GET_ALERTS", true).execute(WebServicesUrls.DEVICE_ALERTS);
    }
