...
import com.voxtrail.voxtrail.adapter.UnderSpeedAdapter;
...
public class UnderSpeedFragment extends FragmentController implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
    ...
    public UnderSpeedFragment(DevicePOJO devicePOJO) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frag_under_speed, container, false);
    ...
    public void callAPI() {
        ...
        try {
            if (!et_stop_duration.getText().toString().trim().equalsIgnoreCase("")) {
                ...
                nameValuePairs.add(new BasicNameValuePair("speed_limit", "10"));
            }
        } catch (Exception e) {
            nameValuePairs.add(new BasicNameValuePair("speed_limit", "10"));
        }
        ...
        new WebServiceBaseResponseList<UnderSpeedPOJO>(nameValuePairs, getActivity(), new ResponseListCallback<UnderSpeedPOJO>() {

            @Override
            public void onGetMsg(ResponseListPOJO<UnderSpeedPOJO> responseListPOJO) {
        ...
        }, UnderSpeedPOJO.class, "DRIVE_IN_OUT_REPORT", false).execute(WebServicesUrls.UNDERSPEED_API);
    }

    UnderSpeedAdapter overSpeedAdapter;
    List<UnderSpeedPOJO> driveStopResultPOJOS = new ArrayList<>();

    public void attachAdapter() {
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false);
        rv_zone_report.setHasFixedSize(true);
        rv_zone_report.setLayoutManager(linearLayoutManager);
        overSpeedAdapter = new UnderSpeedAdapter(getActivity(), null, driveStopResultPOJOS);
