...
public class Pref {
    ...
    private static final String PrefDB = "voxtrail";
    private static final String PerPrefDB = "pervoxtrail";
    ...
    public static void SaveDeviceToken(Context context, String Value) {
        SharedPreferences sp = context.getSharedPreferences("voxtraildevicetoken.txt", MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
